  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-center gap-2 px-4">
          <button
  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[30rem] md:w-96 dark:bg-black"
      >
